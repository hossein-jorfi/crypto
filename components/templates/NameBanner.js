...
//      .catch(err => console.log(err))
  ...
  return (
    <div
      className={`${styles.main} d-flex justify-content-between align-items-center`}
    >
      <div className="d-flex align-items-center">
        ...
        <div className="d-flex flex-column flex-md-row me-2">
          <span className={`${styles.name} p-0 m-0`}>{name} Price</span>
          <span className={`${styles.stand} p-0 me-1 `}>({symbol})</span>
        </div>
      </div>
      {/* <div>
